...
const alerts = [
  {
    ...
    description: "You've spent ₹5,200 on food this month, which is 30% higher than your usual spending.",
    type: "warning",
    date: "2 hours ago",
  ...
  },
  {
    ...
    description: "Your Netflix subscription (₹499) will renew tomorrow. Consider if you still need this service.",
    type: "info",
    date: "1 day ago",
