...
const features = [
  ...
  },
  {
    ...
    description: "Receive personalized notifications that help you make better financial decisions in the moment.",
  },
  {
    icon: <Shield className="h-10 w-10 text-yellow-400" />,
    title: "Secure Encryption",
    description: "End-to-end encryption ensures your financial data remains private and protected at all times.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Our intelligent platform uses cutting-edge AI to transform your financial behavior
          </p>
        </div>
